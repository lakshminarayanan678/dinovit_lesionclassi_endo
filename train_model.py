...
def main():
    ...
    data_dir = '/home/endodl/PHASE-1/mln/lesions_cv24/MAIN/data1/split_data/train_val'  # Update the path as needed
    ...
    # Save the model
    model_save_path = "models/OURS_Split_50epochs_dino_vit_classifier_capsule.pth"
